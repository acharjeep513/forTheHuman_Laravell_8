...
<div class="container" align="center">
    <table class="table table-bordered table-hover table-striped">
            <tr align="center">
                ...
                <th>Action</th>
                <th style="font-size: 20px">Activeted</th>
            </tr>
            ...
            <tr align="center" >
                ...
                <td><a href="{{ url ('/adminEditedSlider/'.$slides->id) }}" class="btn  btn-info">Active</a>
                    <a href="{{ url ('/adminDeleteSlider/'.$slides->id) }}" class="btn  btn-info">Delete</a>
   
                </td>
                @if($loop->index <3)
                <td style="font-size: 25px;background-color: yellow">
                  ...
                  @endif
                  @if($loop->index >=3)
                <td style="font-size: 25px;background-color: green">
